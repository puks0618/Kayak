...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-slate-900 dark:text-gray-100 pb-20 transition-colors">
      {/* Sidebar Menu */}
      {isMenuOpen && (
        <>
          {/* Overlay */}
          ...
          />
          {/* Sidebar */}
          <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-xl z-50 overflow-y-auto pt-16 transition-colors">
            <div className="p-4">
              {/* Categories Section */}
              <div className="mb-6">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          >
            <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300 font-semibold text-sm transition-colors">
              {getUserInitial()}
            </div>
          </button>
          ...
          {isUserMenuOpen && user && (
            <>
              ...
              />
              {/* Popup Menu */}
              <div className="absolute right-0 top-12 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-xl z-50 overflow-hidden transition-colors">
                {/* User Info Section */}
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 font-semibold transition-colors">
                      {getUserInitial()}
                    </div>
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900 dark:text-gray-100">{getDisplayName()}</div>
                  ...
                  {/* Add User Button */}
                  <button className="w-full flex items-center gap-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                    <div className="w-10 h-10 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center transition-colors">
      ...
      <main className="mt-4 md:mt-8">
        ...
        <div className="w-full bg-[#edf0f3] dark:bg-gray-800 py-6 md:py-8 transition-colors">
          ...
          <div className="max-w-[1200px] mx-auto px-2 md:px-3 lg:px-4">
            ...
            <div className="flex flex-wrap gap-4 mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">
              <div className="relative group cursor-pointer flex items-center gap-1 hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded select-none transition-colors">
            ...
            {/* Main Search Bar */}
            <div className="flex flex-col md:flex-row bg-gray-200 dark:bg-gray-700 p-[2px] md:p-[2px] rounded-xl shadow-sm md:shadow-none gap-[2px] transition-colors">
              ...
              <div className="flex-1 relative bg-white dark:bg-gray-800 rounded-t-lg md:rounded-l-lg md:rounded-tr-none p-3.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center group transition-colors">
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <span className="font-medium text-gray-900 dark:text-gray-100 truncate text-[15px]">{origin}</span>
                ...
                {/* Swap Button */}
                <div className="hidden md:flex absolute -right-3.5 z-20 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full p-1.5 shadow-md hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-gray-600 dark:text-gray-300 transition-colors">
              ...
              <div className="flex-1 bg-white dark:bg-gray-800 p-3.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center group relative transition-colors">
                 <div className="md:pl-2 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="font-medium text-gray-900 dark:text-gray-100 truncate text-[15px]">{dest}</span>
                    <X className="w-4 h-4 text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100" onClick={(e) => { e.stopPropagation(); setDest(''); }} />
                  </div>
                </div>
              </div>
              ...
              <div className="flex-[1.5] bg-white dark:bg-gray-800 p-3.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center justify-between transition-colors">
                <div className="flex items-center gap-2 md:pl-2 w-full">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100 text-[15px]">{dates}</span>
                </div>
              </div>
              ...
              <div className="flex-1 bg-white dark:bg-gray-800 rounded-b-lg md:rounded-none p-3.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center group relative transition-colors">
                <div className="md:pl-2 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="font-medium text-gray-900 dark:text-gray-100 truncate text-[15px]">{travelersInfo}</span>
                    <X className="w-4 h-4 text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100" onClick={(e) => { e.stopPropagation(); setTravelersInfo('1 adult, Economy'); }} />
                  </div>
                </div>
              </div>
...
function NavTab({ icon, label, active, link }) {
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <span className={`font-medium text-xs ${active ? 'text-[#FF690F]' : 'text-gray-900 dark:text-gray-200'}`}>
        {label}
      </span>
    </div>
  );
