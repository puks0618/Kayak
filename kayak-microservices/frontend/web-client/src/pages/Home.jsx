...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-slate-900 dark:text-slate-100 pb-20 transition-colors duration-200">
      {/* Sidebar Menu */}
      {isMenuOpen && (
        <>
          {/* Overlay */}
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          >
            <div className="w-8 h-8 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300 font-semibold text-sm">
              S
            </div>
          </button>
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900 dark:text-gray-100">Sheerio217</div>
      ...
      <main className="mt-4 md:mt-8">
        ...
        <div className="w-full bg-[#edf0f3] dark:bg-gray-800 py-6 md:py-8 transition-colors duration-200">
          ...
          <div className="max-w-[1200px] mx-auto px-2 md:px-3 lg:px-4">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight tracking-tight text-slate-900 dark:text-white">
            ...
            <div className="flex flex-col md:flex-row bg-gray-200 dark:bg-gray-700 p-[2px] md:p-[2px] rounded-xl shadow-sm md:shadow-none gap-[2px]">
              ...
              <div className="flex-1 relative bg-white dark:bg-gray-800 rounded-t-lg md:rounded-l-lg md:rounded-tr-none p-3.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center group transition-colors">
                ...
                {/* Swap Button */}
                <div className="hidden md:flex absolute -right-3.5 z-20 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full p-1.5 shadow-md hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-gray-600 dark:text-gray-400">
...
function NavTab({ icon, label, active, link }) {
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <span className={`font-medium text-xs ${active ? 'text-[#FF690F]' : 'text-gray-900 dark:text-gray-100'}`}>
        {label}
      </span>
    </div>
  );
